...
table = [{'Columns View': 'SO Number', 'Sort By': '', 'Highlight By': 'equals=S110=rgba(172,86,86,1)/equals=S111', 'Condition': 'equals=S110,equals=S111', 'Row Height': '60', 'Lines per page': '25'},
         {'Columns View': 'Client PO', 'Sort By': '', 'Highlight By': 'equals=S110,equals=S111', 'Condition': '', 'Row Height': '', 'Lines per page': ''},
         {'Columns View': 'Terms of Sale', 'Sort By': 'asc', 'Highlight By': 'equals=ToS110=rgba(172,86,86,1)', 'Condition': '', 'Row Height': '', 'Lines per page': ''}]
...
result = {'columns': [{'index': 'so_list_so_number', 'sort': 0}, 
          ...
          'color_conditions': {'so_no': [{'type': 'equals', 'value': 'S110', 'color': 'rgba(172,86,86,1)'}], 
                               ...
                               'term_sale': [{'type': 'equals', 'value': 'S113', 'color': ''}, {'type': 'equals', 'value': 'S112', 'color': ''}]}, 
          'module': 'SO'}
